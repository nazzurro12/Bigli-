...
La puerta realiza dos fases:

1. Importa el proyecto en modo headless y rechaza errores de parseo o carga.
2. Carga todos los scripts, instancia `df_mode/df_main.tscn` y permite varios fotogramas de inicialización.
