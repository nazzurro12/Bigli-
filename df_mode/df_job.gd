...
# Fallos de navegación recuperables: la tarea vuelve a la cola después de una
# pausa, en lugar de quedar asignada para siempre o cancelarse al primer atasco.
